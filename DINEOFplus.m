function  [Xr, rms, error_var]  = DINEOFplus( Xo, d1, d2, ind, thrd, logFlag )
...
% - rms: this is an error in cross validation
% - error_var: estimated error of reconstruction
% 
% Haipeng Zhao
% 2/8/2023
...
% 4/7/2026 update parameters' annotation 

interloc = getInterloc( Xo, ind, [d1, d2] );
...
%     end
    ...
    for i = 1 : size( Xr, 2 )
        ind = Xs(:, i) > 0; % Indicate locations of data covered points
        Lp = L(ind, :);
